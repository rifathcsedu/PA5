...
if __name__ == '__main__':
    ...
    frwd_tbl_D = {'data':{'in':'','out':'10','dest':'H2','inf':'1'}}     # table used to forward MPLS frames
    decap_tbl_D = {'decap':{'10':'H2'}}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {'10':'12'}
    frwd_tbl_D = {'data':{'in':'10','out':'12','dest':'H2','inf':'1'}}
    decap_tbl_D = {'decap':{'12':'H2','out':'1'}}
