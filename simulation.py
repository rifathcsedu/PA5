...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H1':{'H2':'10'}}
    frwd_tbl_D = {0:{'source':'H1','in':'','out':'10','dest':'H2','inf':'1'}}     # table used to forward MPLS frames
    decap_tbl_D = {0:{'10':'H1H2'}}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {'10':'10'}
    frwd_tbl_D = {0:{'source':'H1','in':'10','out':None,'dest':'H2','inf':'1'}}
    decap_tbl_D = {0:{'10':'H1H2'}}
